 ...
 */
package ru.petrushin.ya.music.test.exception;
...
public class ErrorMessageFactoryTest extends AndroidTestCase {
  ...
  public void testNetworkConnectionErrorMessage() {
    String expectedMessage = getContext().getString(R.string.exception_message_network);
    String actualMessage =
        ErrorMessageFactory.create(getContext(), new NetworkConnectionException());

    assertThat(actualMessage, is(equalTo(expectedMessage)));
  }

  public void testUndefinedErrorMessage() {
    String expectedMessage = getContext().getString(R.string.exception_message_undefined);
    String actualMessage =
        ErrorMessageFactory.create(getContext(), new IllegalStateException("Any random exception"));
